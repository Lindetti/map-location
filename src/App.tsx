        ...
        <div className="relative w-full h-[200px] overflow-hidden">
          ...
          >
            <path
              fill="#F97316"
              fillOpacity="0.1"
              className="dark:fill-white dark:fill-opacity-30 transition-colors duration-300"
          ...
          >
            <path
              fill="#F97316"
              fillOpacity="0.2"
              className="dark:fill-white dark:fill-opacity-40 transition-colors duration-300"
