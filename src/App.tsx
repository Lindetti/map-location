...
function App() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center font-sans relative overflow-hidden bg-white dark:bg-[#121212]">
      {/* Content */}
        ...
        <div className="relative w-full h-[200px] overflow-hidden">
          ...
          >
            <path
              fill="#F97316"
              fillOpacity="0.3"
              className="dark:fill-orange-500 dark:fill-opacity-30 transition-colors duration-300"
          ...
          >
            <path
              fill="#F97316"
              fillOpacity="0.4"
              className="dark:fill-orange-500 dark:fill-opacity-40 transition-colors duration-300"
