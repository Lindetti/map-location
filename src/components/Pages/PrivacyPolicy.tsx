...
const PrivacyPolicy = () => {
  ...
  return (
    ...
    <div className="max-w-4xl mx-auto p-6 md:p-10 bg-white rounded-lg mt-5 mb-10">
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-3">Vad lagras?</h2>
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-3">Syfte med lagringen</h2>
        <ul className="list-disc pl-6 text-gray-700 leading-relaxed space-y-2">
          <li>
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-3">Hur länge lagras data?</h2>
        <ul className="list-disc pl-6 text-gray-700 leading-relaxed space-y-2">
          <li>
      ...
      <section>
        ...
        <p className="text-gray-700 leading-relaxed">
          Om du har några frågor om denna datahantering eller vill veta mer,
          vänligen kontakta oss{" "}
          <a
            className="text-orange-500"
            href="mailto:alexander_lind95@hotmail.com"
          >
            Här
          </a>
        </p>
